...
import { TrialBalanceRoutes } from './trial-balance.routing';
import { TrialBalanceComponent } from './trial-balance.component';
import { TrialBalanceListComponent } from './list/list.component';
import { TrialBalanceDetailDialogComponent } from './details/dialog/dialog.component';
...
@NgModule({
    declarations: [
        ...
        TrialBalanceDetailDialogComponent,
        NumberToPersianPipe,
    ...
    providers: [
        DialogService, ExcelService, DecimalPipe
    ]
})
