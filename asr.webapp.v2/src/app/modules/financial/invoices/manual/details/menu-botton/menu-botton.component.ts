...
import { ManualInvoiceDetailsComponent } from '../details.component';
...
export class MenuBottonComponent implements OnInit {
  ...
  constructor(public router: Router, private list: ManualInvoiceDetailsComponent) {
  }
  public setSelectedCat(selectedItem: string, selectedId: number): void {
    ...
    this.list.setSelectedCat(selectedId, selectedItem, true);
  }
  ngOnInit() {
  }
}
