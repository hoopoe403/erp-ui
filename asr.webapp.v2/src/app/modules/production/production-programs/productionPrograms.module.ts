...
import { ProductionProgramsRoutes } from './productionPrograms.routing';
...
import { ProductionProgramDialogComponent } from './details/dialog/dialog.component';
...
@NgModule({
    declarations: [
        ProductionProgramsComponent,
        ProductionProgramsListComponent,
        ProductionProgramDialogComponent
    ],
    imports: [
        MatDatepickerModule,
        MatDialogModule,
        ...
        NgxPrintModule,
        RouterModule.forChild(ProductionProgramsRoutes),
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        MatInputModule,
...
export class ProductionProgramsModule {
}
