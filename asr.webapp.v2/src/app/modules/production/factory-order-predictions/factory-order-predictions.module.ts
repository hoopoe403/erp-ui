...
import { FactoryOrderPredictionsRoutes } from './factory-order-predictions.routing';
...
@NgModule({
    declarations: [
        FactoryOrderPredictionsComponent,
        FactoryOrderPredictionsListComponent,
    ],
    imports: [
        MatSnackBarModule,
        MatCheckboxModule,
        ...
        NgxPrintModule,
        RouterModule.forChild(FactoryOrderPredictionsRoutes),
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        MatInputModule,
...
export class FactoryOrderPredictionsModule {
}
