...
import { CanDeactivateFileManagerDetails } from 'app/modules/admin/dashboards/file-manager/file-manager.guards';
...
import { FileManagerFolderResolver, FileManagerItemResolver, FileManagerItemsResolver } from 'app/modules/admin/dashboards/file-manager/file-manager.resolvers';
