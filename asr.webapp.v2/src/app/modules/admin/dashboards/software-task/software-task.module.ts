...
import { SoftwareTaskRoutes } from './software-task.routing';
...
@NgModule({
    declarations: [
        SoftwareTaskComponent,
        SoftwareTaskListComponent,
        SoftwareTaskDetailsComponent
    ],
    imports: [
        HttpClientModule,
        AngularEditorModule,
        ...
        NgxPrintModule,
        RouterModule.forChild(SoftwareTaskRoutes),
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        MatInputModule,
...
export class SoftwareTaskModule {
}
