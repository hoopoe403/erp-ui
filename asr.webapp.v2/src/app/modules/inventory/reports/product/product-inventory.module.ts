...
import { ProductInventoryRoutes } from './product-inventory.routing';
...
import { ProductInventoryDetailDialogComponent } from './details/dialog/product-inventory-detail-dialog.component';
import { InventorySummaryDialogComponent } from './report-summary/dialog/summary-dialog.component';
...
@NgModule({
    declarations: [
        ...
        ProductInventoryDetailDialogComponent,
        InventorySummaryDialogComponent
    ],
    imports: [
        MatSnackBarModule,
        MatCheckboxModule,
        ...
        NgxPrintModule,
        RouterModule.forChild(ProductInventoryRoutes),
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        MatInputModule,
    ...
    providers: [
        ExcelService, DecimalPipe, ProductInventoryDetailDialogService, SummaryDialogService
    ]
})
