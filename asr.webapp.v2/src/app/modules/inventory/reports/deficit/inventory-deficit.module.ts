...
import { InventoryDeficitRoutes } from './inventory-deficit.routing';
...
@NgModule({
    declarations: [
        InventoryDeficitComponent,
        InventoryDeficitListComponent,
    ],
    imports: [
        MatSnackBarModule,
        MatCheckboxModule,
        ...
        NgxPrintModule,
        RouterModule.forChild(InventoryDeficitRoutes),
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        MatInputModule,
...
export class InventoryDeficitModule {
}
