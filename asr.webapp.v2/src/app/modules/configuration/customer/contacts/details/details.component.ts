...
import { Contact, Country, Tag } from 'app/modules/configuration/customer/contacts/contacts.types';
import { ContactsListComponent } from 'app/modules/configuration/customer/contacts/list/list.component';
import { ContactsService } from 'app/modules/configuration/customer/contacts/contacts.service';
