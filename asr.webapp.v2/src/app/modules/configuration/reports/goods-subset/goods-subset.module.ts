...
import { GoodsSubsetRoutes } from './goods-subset.routing';
...
@NgModule({
    declarations: [
        GoodsSubsetComponent,
        GoodsSubsetListComponent
    ],
    imports: [
        MatSnackBarModule,
        MatCheckboxModule,
        ...
        NgxPrintModule,
        RouterModule.forChild(GoodsSubsetRoutes),
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        MatInputModule,
...
export class GoodsSubsetModule {
}
