...
import { ProductSubsetRoutes } from './product-subset.routing';
...
@NgModule({
    ...
    imports: [
        ...
        NgxPrintModule,
        RouterModule.forChild(ProductSubsetRoutes),
        MatButtonModule,
        MatFormFieldModule,
        MatIconModule,
        MatInputModule,
...
export class ProductSubsetModule {
}
